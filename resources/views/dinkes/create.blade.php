                    ...
                    <form class="form-horizontal" method="post" action="{{route('dinkes.store')}}">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Tulis Nama"ype="text" class="form-control" id="nama" name="nama" value="{{old('nama')}}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input placeholder="Tulis Password" type="text" class="form-control" id="password" name="password" value="">
                                </div>
                            </div>
